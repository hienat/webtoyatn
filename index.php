...
<div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active" data-bs-interval="10000">
      <img src="img/wall1.jpg" style="height:600px" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item" data-bs-interval="2000">
      <img src="img/wall2.jpg" style="height:600px" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img/wall3.jpeg" class="d-block w-100" alt="..." style="height:600px">
    </div>
  </div>
      ...
      <?php
        ...
        while ($row = mysqli_fetch_array($result)) {
          echo "<div class='card border-success mb-3' style='max-width: 50%;'>
                      ...
                      <a class='btn btn-warning' href='detail.php?id=".$row['SongID']."'>View Product</a>
